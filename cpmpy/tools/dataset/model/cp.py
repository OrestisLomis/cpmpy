...
class CPDataset(_Dataset): 
    ...
    def __init__(
        ...
        """
        Constructor for a dataset object of local CP instances.
        ...
        super().__init__(
            ...
            download=download, extension=".pkl"
        )
...
if __name__ == "__main__":
    dataset = CPDataset(year=2024, track="DEC-LIN", download=True)
